...
This example shows how to use :meth:{func}`squidpy.im.ImageContainer.generate_spot_crops`.
...
:meth:{func}`squidpy.im.ImageContainer.generate_spot_crops` iterates over :attr:`anndata.AnnData.obsm` and extracts crops.
...
.. seealso::
    - :ref:`sphx_glr_examples_image_compute_crops.py`
...
# In general, :meth:{func}`squidpy.im.ImageContainer.generate_spot_crops` can also process very large images.
...
###############################################################################
# Next, we use :meth:{func}`squidpy.im.ImageContainer.generate_spot_crops` to make a generator that generates cropped images.
...
# Check the documentation of the method :meth:{func}`squidpy.im.ImageContainer.generate_spot_crops`.
