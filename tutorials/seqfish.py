...
# # seqFISH
# This tutorial shows how to apply Squidpy to the analysis of seqFISH data. The data used here comes from a recent paper from `Lohoff et al. https://www.biorxiv.org/content/10.1101/2020.11.20.391896v1`_ . We provide a pre-processed subset of the data, in AnnData format.
#
...
# ### Download data
# To get the data, you can simply run the following command, which downloads the relevant data from this `fighare link `_ and stores it in `~/.cache`. The data provided here has been already pre-processed. For details on how it was pre-processed, please refer to the original `paper https://www.biorxiv.org/content/10.1101/2020.11.20.391896v1`_ .
...
# First, let's visualize cell type annotation in spatial contextn with `scanpy.pl.spatial https://scanpy.readthedocs.io/en/stable/api/scanpy.pl.spatial.html`_ .
