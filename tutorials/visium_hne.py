...
# The original dataset is publicly availbale at the
# 10x genomics `dataset portal <https://support.10xgenomics.com/spatial-gene-expression/datasets>`_ .
# Here, we provide a pre-processed dataset, with pre-annoated clusters, in AnnData format.
# Couple of notes on pre-processing:
# - The pre-processing pipeline is the same as the one showed in the original
