...
.. _auto_examples_graph_compute_sepal.py:
...
:::{seealso}
    ...
    - See {doc}`auto_examples_graph_compute_co_occurrence.py` and
      {ref}`auto_examples_graph_compute_moran.py` for other scores to identify spatially variable genes.
...
.. image-sg:: /auto_examples/graph/images/compute_sepal_001.png
   :alt: Lct, Ecel1, Cfap65
   :srcset: /auto_examples/graph/images/compute_sepal_001.png
...
.. _download_auto_examples_graph_compute_sepal.py:
